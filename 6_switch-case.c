...
int main ()
{
	...
	scanf("%i",&note);											//der Adressoperator ist wichtig! Sonst stürzt das Programm ab.

	switch(note)
	{
		case 1:printf("\nDas ist eine sehr gute Leistung");
				break;											//break ist notwendig, sonst läuft der alles nach dem ersten True-Wert durch.
